        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div
            style={{
              ...
              transition: "opacity var(--reveal-lg) calc(200ms * var(--stagger-scale)) cubic-bezier(0.16,1,0.3,1), transform var(--reveal-lg) calc(200ms * var(--stagger-scale)) cubic-bezier(0.16,1,0.3,1)",
            }}
          >
          ...
          <div
            style={{
              opacity: isVisible ? 1 : 0,
              transform: isVisible ? "translateX(0) scale(1)" : "translateX(80px) scale(0.97)",
              transition: "opacity var(--reveal-lg) calc(400ms * var(--stagger-scale)) cubic-bezier(0.16,1,0.3,1), transform var(--reveal-lg) calc(400ms * var(--stagger-scale)) cubic-bezier(0.16,1,0.3,1)",
            }}
          >
